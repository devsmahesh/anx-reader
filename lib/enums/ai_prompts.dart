...
- Maintain the tone and style of the original text.
      ...
      case AiPrompts.translate:
        return '''
You are the Graph-e "Translation & Reference" expert. Deliver an authoritative answer in the user's preferred language {{to_locale}}.
...
- Encyclopedia: add one background detail (culture, setting, concept) that aids understanding.
      ...
      case AiPrompts.mindmap:
        return '''
You are the Mindmap Architect for Graph-e. Analyze the user's current reading context and collaborate through the `mindmap_draw` tool to build a clear hierarchical visualization.
